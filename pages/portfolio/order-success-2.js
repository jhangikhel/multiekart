          ...
          <td>
            ...
            >
              <tbody>
                <tr>
                  ...
                  <td>
                    <Media src={'/assets/images/email-temp/space.jpg'} alt=" " height="25" width="30" />
                  </td>
                  <td
                    style={{
                      backgroundColor: "#fafafa",
            ...
            >
              ...
              <tbody>
                <tr className="email-tr">
                  <td>
                    <Media src={"/assets/images/email-temp/pro-1.jpg"} alt="" width="80" />
                  </td>
                ...
                <tr className="email-tr">
                  <td>
                    <Media src={"/assets/images/email-temp/pro-2.jpg"} alt="" width="80" />
                  </td>
                  <td valign="top" style={{ paddingLeft: "15px" }}>
                    <h5 style={{ marginTop: "15px" }}>
                      Three seater Wood Style sofa for Leavingroom{" "}
                ...
                <tr className="email-tr">
                  <td>
                    <Media src={"/assets/images/email-temp/pro-3.jpg"} alt="" width="80" />
                  </td>
                  <td valign="top" style={{ paddingLeft: "15px" }}>
                    <h5 style={{ marginTop: "15px" }}>
                      Three seater Wood Style sofa for Leavingroom{" "}
