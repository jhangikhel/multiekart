...
const ItemsData = [
  {
    img: "/assets/images/email-temp/pro-1.jpg",
    link: "#",
    about: "When an unknown.",
    price: "$45.00",
  },
  {
    img: "/assets/images/email-temp/pro-2.jpg",
    link: "#",
    about: "When an unknown.",
    price: "$45.00",
  },
  {
    img: "/assets/images/email-temp/pro-3.jpg",
    link: "#",
    about: "When an unknown.",
    price: "$45.00",
  },
...
const BottomImages = [
  { img: "/assets/images/email-temp/6.png", link: "#" },
  { img: "/assets/images/email-temp/5.png", link: "#" },
];
          ...
          <td>
            ...
            >
              <tbody>
                <tr>
                  <td>
                    <Media src={"/assets/images/email-temp/1.jpg"} alt="" style={{ width: "100%" }} />
                  </td>
                </tr>
              </tbody>
            </Table>
            ...
            <Table border="0" cellPadding="0" cellSpacing="0" width="100%">
              <tbody>
                <tr style={{ textAlign: "center" }}>
                  <td>
                    <a href="#">
                      <Media src={"/assets/images/email-temp/cosmetic.jpg"} style={{ width: "100%" }} />
                    </a>
                  </td>
                </tr>
              </tbody>
