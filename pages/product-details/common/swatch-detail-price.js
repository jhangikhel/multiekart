    ...
    <>
      <div className={`product-right ${params.stickyClass}`}>
        ...
        <ul className="image-swatch">
          <li className="active">
            <a href="#">
              <img src={'/assets/images/fashion/pro/001.jpg'} alt="" className="img-fluid blur-up lazyloaded" />
            </a>
          </li>
          <li>
            <a href="#">
              <img src={"/assets/images/fashion/pro/002.jpg"} alt="" className="img-fluid blur-up lazyloaded" />
            </a>
          </li>
          <li>
            <a href="#">
              <img src={"/assets/images/fashion/pro/02.jpg"} alt="" className="img-fluid blur-up lazyloaded" />
            </a>
          </li>
        </ul>
